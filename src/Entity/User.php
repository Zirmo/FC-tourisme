...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column]
    #[Assert\NotBlank]
    #[Assert\Length(min:8,minMessage:'mot de passe de 8 caracteres minimum ')]
    private ?string $password = null;

    #[ORM\Column(length: 60)]
    #[Assert\NotBlank]
    #[Assert\Length(min:2,minMessage:'prenom entre 2 et 60 caracteres')]
    private ?string $prenom = null;

    #[ORM\Column(length: 60)]
    #[Assert\NotBlank]
    #[Assert\Length(min:2,minMessage:'nom entre 2 et 60 caracteres')]
    private ?string $nom = null;

    #[ORM\Column(length: 60, nullable: true)]
    #[Assert\NotBlank]
    #[Assert\Length(min:2,minMessage:'pseudo entre 2 et 60 caracteres')]
